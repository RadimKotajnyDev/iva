    ...
    <>
      <nav className="w-full flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-semibold text-primary-foreground">IVA s.r.o.</h1>
          <span className="w-[1px] h-5 bg-primary-foreground" />
          <h2 className="text-xl text-primary-foreground">Vzdělávací agentura</h2>
        </Link>
